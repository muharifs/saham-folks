...
export default function Home() {
  return (
    <>
      <section
        id="home"
        className="relative mt-20 w-screen h-[90vh] max-h-[1080px] overflow-x-hidden"
      >
      ...
      >
        <div className="bg-muted/50 min-h-[100vh] flex-1 rounded-xl md:min-h-min px-20 py-10">
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6 lg-text-lg text-center">
            ...
            tertentu, tetapi bisa dipelajari oleh siapa saja yang ingin
            mengelola keuangan dengan lebih baik dan membangun masa depan
            finansial yang kuat.
          </p>
        </div>
      </section>
      <section
        id="comunity"
        className="container mx-auto my-10 px-4 sm:px-0 gap-16 items-center flex"
      >
        <div className="w-full lg:w-1/2">
          ...
          <div className="flex gap-y-4">
            <div className="basis-4/12 space-y-2 ">
              <img
                src={Logo}
                alt="Logo"
                className="h-15 w-auto color:transparent"
              />
              <p className="text-sm text-left">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Et
                eligendi quibusdam est aliquam nihil magnam minus aspernatur
                dolorem? Expedita, minus?
              </p>
              <div className="flex flex-row gap-4 mt-2">
                <Link to="/">
                  <img
                    src={ig}
                    alt="Insta"
                    className="h-7 w-auto color:transparent"
                  />
                </Link>
                <Link to="/">
                  <img
