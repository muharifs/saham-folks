      ...
      >
        <main className="flex flex-col lg:flex-row w-full gap-4 px-4 md:px-15">
          ...
          <img
            ...
            className="h-48 w-96 object-fill md:w-full md:h-72"
          />
          ...
          <div className="border-muted-foreground border-y py-8 mt-3">
          ...
          <div className="flex gap-2 my-6 justify-end text-secondary-foreground">
